...
const Section = ({
  ...
  <div className="mb-8">
    ...
    {pre ? (
      <pre className="text-background/80 leading-relaxed whitespace-pre-wrap font-sans">
        {body}
      </pre>
    ) : (
    ...
    {extra && (
      <p
        className={`mt-3 leading-relaxed ${extraBold ? "font-bold text-background" : "text-background/80"}`}
      >
        {extra}
      </p>
    )}
    ...
    <div className="min-h-screen bg-[hsl(var(--primary))] text-foreground pt-28 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-sm text-background/60 mb-10">
          {isDE
            ? "NOJA Productions KLG — Stand: März 2026"
            : "NOJA Productions KLG — As of: March 2026"}
        </p>
        ...
        <Section
          title={
            isDE
              ? "4. Hosting & Auslieferung (Technisch notwendige Cookies)"
              : "4. Hosting & Delivery (Technically Necessary Cookies)"
          }
          body={
            isDE
        ...
        <Section
          title={
            isDE
              ? "5. Kein Marketing oder Analytics"
              : "5. No marketing or analytics"
          }
          body={
            isDE ? "Wir verwenden derzeit nicht:" : "We currently do not use:"
          }
          bullets={
            isDE
              ? [
        ...
        <Section
          ...
          body={
            isDE
              ? "Wir wenden Datensparsamkeit und Sicherheitsmaßnahmen an:"
              : "We apply data minimization and security measures:"
          }
          bullets={
            isDE
              ? [
        ...
        <Section
          ...
          bullets={
            isDE
              ? [
                  "Cookies über die Browser-Einstellungen blockieren",
          ...
          extra={
            isDE
              ? "Hinweis: Dies kann die Funktionalität beeinträchtigen."
              : "Note: This may affect functionality."
          }
        />
